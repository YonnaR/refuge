    ...
    <div className="container">
        ...
        <div className="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center  welcome-image">
            <div className="col-md-5 p-lg-5 mx-auto bg-light my-5">
                ...
                <a className="btn btn-primary" data-toggle="collapse" href="#collapseExample" role="button">Voir Plus</a>
            </div>
        </div>
        <br/>
        ...
        <div className="d-md-flex flex-md-equal w-100 my-md-3 pl-md-3">
            <div className=" border-box bg-dark mr-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center text-white overflow-hidden">
                ...
                <div className="bg-light shadow-sm mx-auto" style={{width: "80%", height: "300px", borderRadius: "21px 21px 0 0"}}>
                    <img style={{width:"100%"}} alt="poisson grillé et gratin de fruit a pain" src="/images/restau/poissonG.png" />
                </div>                
            </div>
            <div className=" border-box bg-light mr-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
                ...
                <div className="bg-dark shadow-sm mx-auto" style={{width: "80%", height: "300px", borderRadius: "21px 21px 0 0"}}>
                    <img style={{width:"100%"}} alt="refuge hulman vue depuis l'entré du site" src="/images/excursion/image001.jpg" />
                </div>
            </div>
        </div>
    </div>
